...
Quarto (Pandoc convert MD to HTML) + engine (convert style to PDF) + R / Python (computations)
...
- CSS based :
  ...
  - `weasyprint`
  - `pagedjs-cli` / `pagedown`
  - Prince
  - ...
  
## Comparison

Pros/cons of Typst, `weasyprint`, `pagedjs-cli`
...
- Just write things one after another

## Create a template with CSS tools

`pagedown` example (in French): 
...
- think about the extreme cases (long names)
